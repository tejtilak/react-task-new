  ...
  return (
    <div className="container mt-5">
      <div className="row ">
        ...
        <div className="col-md-6 mt-5 ">
          ...
          <div className="media border p-3   box-shadow">
            ...
            <div className="media-body p-3 ">
              ...
              <p>
                At Task N Task we want to be the leading provider of net zero
                solutions for fleet, property and waste to support current and
                future customer engagement, and to be the best performing and
                most trusted supply chain partner.
              </p>
            </div>
          </div>
        </div>
        <div className="col-md-6 mt-3 pding ">
          <div className="media border p-3  box-shadow">
            ...
            <div className="media-body p-3 ">
              ...
              <p>
                ...
                delivering goods as they travel from source to retailers, sites
                and homes across the Pakistan.
              </p>
            </div>
          </div>
        </div>
        <div className="col-md-6  mt-5 ">
          <div className="media border p-3  box-shadow">
            <i className="fa-solid fa-suitcase service-icon-services"></i>
            <div className="media-body p-3 ">
              <h4>
              ...
              <p>
                ...
                provide fully flexible transport services, incorporating
                dedicated fleets and our nationwide shared network, unlocking
                operational efficiencies and ensuring your supply chain runs
                effectively.
              </p>
            </div>
          </div>
